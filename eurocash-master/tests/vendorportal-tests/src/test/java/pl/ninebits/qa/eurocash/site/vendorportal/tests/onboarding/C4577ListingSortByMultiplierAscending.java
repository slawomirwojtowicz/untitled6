...
public class C4577ListingSortByMultiplierAscending extends VendorPortalTestTemplate {

  @Test(groups = {"production", "preprod", "uat"}, description = "vendor onboarding - sort by multiplier ascending")
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C4577")
  public void listingSortByMultiplierAscendingTest() throws Exception {
    ...
    vendorsPage.checkDataSortedByMultiplierAscending(errors);
