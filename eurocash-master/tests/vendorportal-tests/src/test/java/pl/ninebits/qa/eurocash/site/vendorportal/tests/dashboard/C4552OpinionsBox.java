...
public class C4552OpinionsBox extends VendorPortalTestTemplate {

  @Test(groups = {"production", "preprod", "uat"}, description = "dashboard - check opinions box exists")
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C4552")
  public void opinionsBoxTest() throws Exception {
    ...
    vendorDashboardPage.checkOpinionsBox(errors);
