...
import pl.ninebits.qa.eurocash.site.vendorportal.pages.RatingPage;
...
public class C4559ShowOpinionsDetails extends VendorPortalTestTemplate {

  @Test(groups = {"production", "preprod", "uat"}, description = "dashboard - check can show opinions details")
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C4559")
  public void showOpinionsDetailsTest() throws Exception {
    ...
    RatingPage ratingPage = vendorDashboardPage.clickShowOpinionsDetails();
    ratingPage.checkAdminRatingsPresent(errors);
