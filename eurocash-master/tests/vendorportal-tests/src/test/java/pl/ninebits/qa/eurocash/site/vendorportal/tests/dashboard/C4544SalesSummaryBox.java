...
public class C4544SalesSummaryBox extends VendorPortalTestTemplate {

  @Test(groups = {"production", "preprod", "uat"}, description = "dashboard - check sales summary box exists")
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C4544")
  public void salesSummaryBoxTest() throws Exception {
