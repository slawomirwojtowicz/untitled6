...
public class C154AddListToCartWithProducts extends EhurtTestTemplate {

  @Test(groups = {"production", "preprod", "uat"})
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C154")
  public void addListToCartWithProductsTest() throws Exception {
    ...
    offerPage.addSearchPhrase("WHISKY");
    offerPage.confirmSearch();
    offerPage.enterUnits(2, packageAmount);
    barCodes.add(offerPage.getProductBarCodes(1, 1).get(0));
    CartStep1Page cartStep1Page = offerPage.clickGoToCartLink();

    cartStep1Page.clickListActionMenu();
    cartStep1Page.addProductsFromListToCart(listName, errors);
