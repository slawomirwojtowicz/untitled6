...
public class C2142EditAgreements extends EhurtTestTemplate {

  @Test(groups = {"production", "preprod", "uat"})
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C2142")
  public void editAgreementsTest() throws Exception {
    String phoneNumber = RandomStringUtils.random(9, false, true);
    EhurtAppUser ehurtAppUser = getEhurtAppUser();
    String email = ehurtAppUser.getLogin() + "@9bits.pl";
    ...
    if (!shopAccountPage.checkAgreementsBoxesPresent(errors)) {
      ...
      email = TextUtils.generate9bLogin(8);
      phoneNumber = RandomStringUtils.random(9, false, true);
      shopAccountPage.agreeForEmail(email, errors);
      shopAccountPage.agreeForSMS(phoneNumber, errors);
      shopAccountPage.agreeForCalls(phoneNumber, errors);
