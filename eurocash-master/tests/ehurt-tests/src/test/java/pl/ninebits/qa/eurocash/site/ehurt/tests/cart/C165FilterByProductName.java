...
public class C165FilterByProductName extends EhurtTestTemplate {

  @Test(groups = {"production", "preprod", "uat"})
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C165")
  public void filterByProductNameTest() throws Exception {
    ...
    cartStep1Page.enterSearchPhrase(productNames.get(0));
    cartStep1Page.checkCartSize(1, errors);
