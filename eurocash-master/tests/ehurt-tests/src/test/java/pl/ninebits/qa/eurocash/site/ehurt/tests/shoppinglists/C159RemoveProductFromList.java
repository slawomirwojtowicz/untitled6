...
public class C159RemoveProductFromList extends EhurtTestTemplate {

  @Test(groups = {"production", "preprod", "uat"})
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C159")
  public void removeProductFromListTest() throws Exception {
    ...
    shoppingListPage.clickRemoveFirstProduct();
    int listSizeAfterDeletion = shoppingListPage.getListSize();
    shoppingListPage.checkProductsRemoved(listSize, listSizeAfterDeletion, 1, errors);
