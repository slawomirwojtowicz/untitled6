...
public class C3673CancelYourOrderVendora extends MarketplaceTestTemplate {

  @Test(groups = {"uat", "dev"})
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C3673")
  public void cancelYourOrderVendoraTest() throws Exception {
    ...
    val reason = "Produkty tymczasowo niedostępne";
