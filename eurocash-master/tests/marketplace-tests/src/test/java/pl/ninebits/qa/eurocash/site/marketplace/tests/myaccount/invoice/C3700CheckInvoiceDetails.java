...
public class C3700CheckInvoiceDetails extends MarketplaceTestTemplate {

  @Test(groups = {"uat", "dev"})
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C3700")
  public void checkInvoiceDetailsTest() throws Exception {
    ...
    invoiceDetailsPage.checkInvoiceDetails(errors);
    invoiceDetailsPage.checkOrderedProducts(errors);
