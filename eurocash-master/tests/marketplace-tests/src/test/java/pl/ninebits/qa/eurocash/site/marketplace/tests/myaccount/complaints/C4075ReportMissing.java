...
public class C4075ReportMissing extends MarketplaceTestTemplate {

  @Test(groups = {"uat", "dev"})
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C4075")
  public void reportMissingTest() throws Exception {
    ...
    newComplaintPage.clickIWantToReportLackBtn();

    ComplaintForm complaintForm = newComplaintPage.selectComplaint();
    complaintForm.complaintTypeBtn(ComplaintType.NOT_SUPPLIED);
