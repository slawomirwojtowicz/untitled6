...
public class C3722CreateShoppingList extends MarketplaceTestTemplate {

  @Test(groups = {"uat", "dev"})
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C3722")
  public void createShoppingListTest() throws Exception {
    ...
    ListForm listForm = invoiceDetailsPage.clickSaveAsShoppingList();
    ...
    shoppingListPage.checkProductNamePresent(mName, errors);
