...
public class C3696SaveToShoppingList extends MarketplaceTestTemplate {

  @Test(groups = {"uat", "dev"})
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C3696")
  public void saveToShoppingListTest() throws Exception {
    ...
    val listName = "TestyAutomatyczne" + RandomStringUtils.randomAlphabetic(9);
    ...
    DeliveryDetailsPage deliveryDetailsPage = deliveryPage.clickDeliveryNumberBtn();
    ListForm listForm = deliveryDetailsPage.clickSaveListBtn();
    listForm.typeListQuery(listName);
    listForm.clickAddList();
    listForm.clickCloseWindowBtn();

    mDashboardPage.header.clickShoppingBtn();
