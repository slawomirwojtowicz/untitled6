...
public class C3719CreateNewListWhenMovingListFromCart extends MarketplaceTestTemplate {

  @Test(groups = {"uat", "dev"})
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C3719")
  public void createNewListWhenMovingListFromCartTest() throws Exception {
    ...
    cartStep1Page.selectProductInCart();
    cartStep1Page.clickMoveToList();
