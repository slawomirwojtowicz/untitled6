...
public class C3721LackOfInvoiceNumber extends MarketplaceTestTemplate {

  @Test(groups = {"uat", "dev"})
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C3721")
  public void lackOfInvoiceNumberTest() throws Exception {
    ...
    orderDetailsPage.checkEnterInvoiceNumber(errors);
    orderDetailsPage.clickCancelBtn();
