...
public class C3691MoveToCart extends MarketplaceTestTemplate {

  @Test(groups = {"uat", "dev"})
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C3691")
  public void moveToCartTest() throws Exception {
    ...
    deliveryPage.clickCheckboxDelivery();
    deliveryPage.moveToCart();
    deliveryPage.footer.clickGoToCartBtn();
    cartStep1Page.checkProductInCartPresent(mName);
