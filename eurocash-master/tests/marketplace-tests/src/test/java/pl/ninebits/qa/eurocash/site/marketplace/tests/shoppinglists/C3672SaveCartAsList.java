...
public class C3672SaveCartAsList extends MarketplaceTestTemplate {

  @Test(groups = {"uat", "dev"})
  @TestRailCase(projectId = TEST_RAIL_PROJECT_ID, caseId = "C3672")
  public void saveCartAsListTest() throws Exception {
    ...
    cartStep1Page.clickExistingList(listName);
