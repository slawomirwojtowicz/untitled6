...
public class C4642ComplaintRejection extends MarketplaceTestTemplate {
  ...
  public void complaintRejectionTest() throws Exception {
    ...
    lineDetailsPage.clickDoNotAcceptBtn();
    editComplaintPage = lineDetailsPage.clickApproveBtn();
    editComplaintPage.checkComplaint(complaintNumber, errors);
    lineDetailsPage = editComplaintPage.clickRejectedBtn();
    lineDetailsPage.checkComplaintStatusRejected(errors);
    ...
    complaintDetailsPage.checkRejectedComplaint(errors);
